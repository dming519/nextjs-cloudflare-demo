...
// ../.wrangler/tmp/bundle-hww2vo/checked-fetch.js
...
var onRequestPost2 = /* @__PURE__ */ __name(async (context) => {
  ...
  try {
    ...
    await bucket.put(body.filename, new TextEncoder().encode(body.content), {
      ...
      customMetadata: { createdAt: (/* @__PURE__ */ new Date()).toISOString() }
    });
...
// ../.wrangler/tmp/pages-HcTt1X/functionsRoutes-0.7055146531546199.mjs
var routes = [
  {
    routePath: "/api/d1",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-hww2vo/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-hww2vo/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8418441855555674.mjs.map
